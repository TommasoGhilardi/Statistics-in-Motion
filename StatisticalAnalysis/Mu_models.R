...
rejection = c('S_Stat_06','S_Stat_09','S_Stat_13','S_Stat_17','S_Stat_19','S_Stat_21',
...
ErroBar = ggplot(means, aes(x =  Probabilities, y = Mean)) +
  ...
  ylab("log(Mu Power)")+ ylim(0.25,0.75)+
  theme(legend.position="none",panel.grid.minor = element_line(size = 1),
        panel.grid.major = element_line(size = 1))
ggsave('C:\\Users\\krav\\surfdrive\\Projects\\InfantEEG\\Results\\Mu_AnovaErrorbar.png',device = "png", width = 20, height = 20, units = "cm",dpi=500)
...
Final
ggsave('C:\\Users\\krav\\surfdrive\\Projects\\InfantEEG\\Results\\Mu_AnovaAll.png',Final,device = "png", width = 20, height = 20, units = "cm",dpi=500)
...
ggplot(df, aes(x = Probability, y = Power)) +
  ...
  geom_pointrange(data = means, aes(as.numeric(as.character(Probabilities)),
    ...
    ylim(-1,2)+ scale_x_continuous( breaks = seq(-25, 100, by = 25))+ ylab("log(Mu Power)")+
...
ggplot(df, aes(x = Probability, y = Power)) +
  ...
  geom_pointrange(data = means, aes(as.numeric(as.character(Probabilities)),
                                    y = Mean, ymin = CI_low, ymax = CI_high), size = 1, color = "white" ) +
  ylim(-1,2) + scale_x_continuous(limits=c(-12, 112),breaks = seq(0, 100, by = 25))+ylab("log(Mu Power)")+
  theme(panel.grid.minor = element_line(size = 1), panel.grid.major = element_line(size = 1),
        text = element_text(size = 22)) 
ggsave('C:\\Users\\krav\\surfdrive\\Projects\\InfantEEG\\Results\\Mu_WholeViolin.png',device = "png", width = 25, height = 20, units = "cm",dpi=500)
...
ggsave('C:\\Users\\krav\\surfdrive\\Projects\\InfantEEG\\Results\\Mu_Zoomed.png',device = "png", width = 15, height = 20, units = "cm",dpi=500)
